...
- [ ] [P2] Preserve resolved benchmark symbol instead of defaulting to `^NSEI`.
...
- [ ] [P2] Clear `pendingAutoSymbol` even when symbol is already present.
...
- [ ] [P3] Treat tab id `0` as a valid tab identifier.
